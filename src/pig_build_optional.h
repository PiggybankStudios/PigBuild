/*
File:   pig_build_optional.h
Author: Taylor Robbins
Date:   08\01\2026
	** This file is like pig_build.h but for all the files that exist in the "optional" folder.
	** These optional headers are mostly for PigCore-based projects or other PiggybankStudios repositories.
	** They are included in PigBuild for reference but not expected to be used by other projects
*/

#ifndef _PIG_BUILD_OPTIONAL_H
#define _PIG_BUILD_OPTIONAL_H
